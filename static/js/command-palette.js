...
const PALETTE_COMMANDS = [
  { label: "New Invoice", url: "/invoices/new", icon: "🧾" },
  { label: "New Quote", url: "/quotes/new", icon: "💼" },
  { label: "New Contract", url: "/contracts/new", icon: "📝" },
  { label: "New Client", url: "/clients/new", icon: "👤" },
  { label: "Log Hours", url: "/hours", icon: "⏱" },
  { label: "Start Timer", url: "/timer", icon: "⏱" },
  { label: "Add Expense", url: "/expenses", icon: "💸" },
  { label: "View Invoices", url: "/invoices", icon: "🧾" },
  { label: "View Quotes", url: "/quotes", icon: "💼" },
  { label: "View Contracts", url: "/contracts", icon: "📝" },
  { label: "View Projects", url: "/scoped-projects", icon: "🗂" },
  { label: "View Reports", url: "/reports", icon: "📈" },
  { label: "View Calendar", url: "/calendar", icon: "📅" },
  { label: "A/R Ageing Report", url: "/invoices/ageing", icon: "📊" },
  { label: "Overdue Invoices", url: "/invoices/overdue", icon: "⚠" },
  { label: "Settings", url: "/settings", icon: "⚙" },
  { label: "Backup Data", url: "/backup", icon: "💾" },
  { label: "Import Data", url: "/import", icon: "📥" },
  { label: "Search", url: "/search", icon: "🔍" },
];
